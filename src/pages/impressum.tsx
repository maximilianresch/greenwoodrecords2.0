...
export default function Impressum() {
  return (
    <Main>
      ...
      <p className="adsimple-221142003"></p>
      <p>Fabian Hainzl</p>
      <p className="adsimple-221142003">
        Gföhlerstraße 34, Tür 1 (Hinteres Haus), <br />
        3552 Lengenfeld, <br />
        Österreich
      </p>
      <p className="adsimple-221142003">
        <strong>Tel.:</strong> +43 660 3002487
        <br />
        <strong>E-Mail:</strong>{" "}
        <a href="mailto:office@greenwoodrecords.at">
      ...
      <p style={{ marginTop: "15px" }}>
        ...
        <a
          href="https://www.augenlaserinfo.com"
          target="_blank"
          rel="follow"
          title=""
          style={{ textDecoration: "none" }}
      ...
      <h2 className="adsimple-221142003">EU-Streitschlichtung</h2>
      <p>
        ...
        <a
          className="adsimple-221142003"
          href="https://ec.europa.eu/consumers/odr/main/index.cfm?event=main.home2.show&lng=DE"
          target="_blank"
          rel="nofollow"
        >
          http://ec.europa.eu/odr?tid=221142003
        </a>{" "}
      ...
      <h2 className="adsimple-221142003">
      ...
      <p>
        ...
        <a
          className="adsimple-221142003"
          href="https://www.ris.bka.gv.at/Dokument.wxe?Abfrage=Bundesnormen&Dokumentnummer=NOR40025813&tid=221142003"
          target="_blank"
      ...
      <h2 className="adsimple-221142003">Urheberrechtshinweis</h2>
      <p>
      ...
      <h2 className="adsimple-221142003">Bildernachweis</h2>
      <p>
